...
export default function AdminRoute({ children }) {
  ...
  // Se non loggato → vai al login admin
  if (!role) return <Navigate to="/login_admin" replace />;

  // Se loggato ma non admin → vai alla home
  if (role !== "admin") return <Navigate to="/" replace />;

  // Se admin → mostra la pagina richiesta
  return children;
}
